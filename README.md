...
* Rendering depends on external site layout (not controllable) — if your theme forces its own styling over your plugin settings, you might have to modify your theme's CSS files accordingly: in particular, look out for `!important` flags
